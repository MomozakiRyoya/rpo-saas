      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="求人タイトル・顧客名・勤務地で検索..."
              className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all bg-white"
              value={searchQuery}
