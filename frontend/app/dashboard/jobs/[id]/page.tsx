      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="min-w-0">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-2">
            <span
              className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${statusStyles[job.status] || "bg-gray-100 text-gray-600"}`}
            >
        ...
        >
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <div className="flex items-center text-xs text-gray-400">
              ...
              {new Date(textVersion.createdAt).toLocaleString("ja-JP", {
                year: "numeric",
                month: "short",
                day: "numeric",
                hour: "2-digit",
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 min-w-0">
                    <div
                      className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${publicationDotStyles[pub.status] || "bg-blue-400"}`}
                    ></div>
                    <div className="min-w-0">
                  ...
                  <div className="flex flex-col items-end flex-shrink-0 ml-3">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${publicationStatusStyles[pub.status] || "bg-blue-100 text-blue-700"}`}
                    >
                      {pub.status}
                    </span>
                    {pub.publishedAt && (
