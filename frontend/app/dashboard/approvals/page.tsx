      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">レビュー待ちの求人を確認して承認または差戻しを行います</p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
            ...
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#FFF1F2', color: '#E11D48' }}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                  </svg>
                </div>
                <span className="text-sm font-semibold text-gray-900">承認待ちリスト</span>
              </div>
            ...
            <ul role="list" className={viewMode === 'grid' ? "divide-y divide-gray-100" : "space-y-0"}>
              {approvals.length === 0 ? (
                <li className="px-5 py-12 text-center">
                  ...
                  <p className="text-sm text-gray-600 font-medium">承認待ちの求人はありません</p>
                  <p className="text-xs text-gray-500 mt-1">すべての求人が処理されました</p>
                </li>
              ) : viewMode === 'grid' ? (
                  ...
                  >
                    <div className="flex items-center justify-between min-w-0">
                      <div className="flex items-center space-x-3 min-w-0">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#FFF1F2', color: '#E11D48' }}>
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex flex-wrap items-center gap-4 pt-3 border-t border-gray-100">
                        <div className="flex items-center text-sm min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-sm font-medium text-gray-900 truncate">{approval.job?.customer?.name}</p>
                          </div>
                        </div>
        ...
        {selectedApproval ? (
            ...
            <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden sticky top-4 lg:top-6" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
              ...
              <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-semibold text-gray-900">承認詳細</span>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 border border-dashed border-gray-200 rounded-2xl p-12 text-center">
              ...
              <p className="text-xs text-gray-500">左側から承認する求人をクリックします</p>
            </div>
          </div>
        )}
      </div>
