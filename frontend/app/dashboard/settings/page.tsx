  ...
  return (
    <div className="px-4 sm:px-0 max-w-3xl">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">アプリケーション全体の設定を管理します</p>
      </div>
      ...
      <div className="space-y-5">
          ...
          <div className="px-5 py-5 space-y-3">
            <div className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">重要なイベントをメールで受け取る</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Slackに通知を送信する</p>
              </div>
              <button
        ...
        >
          ...
          <div className="px-5 py-5 space-y-3">
            <div className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
              <div>
                <p className="text-sm font-medium text-gray-900">AIテキスト生成</p>
                <p className="text-xs text-gray-500 mt-0.5">求人テキストの自動生成を有効にする</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">求人画像の自動生成を有効にする</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">AI生成コンテンツを自動承認する</p>
              </div>
              <button
