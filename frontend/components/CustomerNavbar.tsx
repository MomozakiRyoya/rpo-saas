        ...
        <div className="flex items-center space-x-2 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-teal-200 text-xs truncate">
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-4">
        {NAV_SECTIONS.map((section) => (
          <div key={section.label}>
            <p className="px-3 mb-1 text-xs font-semibold text-teal-300 uppercase tracking-widest">
              {section.label}
            </p>
              ...
              {section.items.map((item) => {
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      <span className={active ? "text-white" : "text-teal-300"}>
                        {item.icon}
                      </span>
      ...
      <div className="border-t border-teal-700/50 p-3">
        <div className="flex items-center space-x-2 mb-2 px-2 py-1.5 rounded-md hover:bg-white/10 cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-teal-300 text-xs truncate">採用企業担当者</p>
          </div>
        </div>
        <button
          onClick={handleLogout}
          className="w-full flex items-center space-x-2 px-3 py-1.5 rounded-md text-teal-200 hover:text-white hover:bg-white/10 text-sm transition-all duration-150 cursor-pointer"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
