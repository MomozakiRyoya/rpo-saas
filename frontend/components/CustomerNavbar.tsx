    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
        <div className="flex items-center space-x-2 min-w-0">
          <div className="w-7 h-7 bg-teal-600 rounded-lg flex items-center justify-center shrink-0 shadow-md">
      ...
      <div className="border-t border-gray-200 p-3">
        <div className="flex items-center space-x-2 mb-2 px-2 py-1.5 rounded-md hover:bg-gray-100 cursor-pointer transition-colors">
          <div className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white font-bold text-sm shrink-0">
            {user?.name?.charAt(0) ?? "?"}
          </div>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-500 text-xs truncate">採用企業担当者</p>
          </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-900 font-bold text-sm">顧客ポータル</span>
        </div>
        <button
