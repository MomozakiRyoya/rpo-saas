...
export class CustomerController {
  ...
  async findAll(
    ...
    return this.customerService.findAll(req.user.tenantId, Number(page) || 1, Number(limit) || 20);
  }
  ...
  async update(
    ...
    return this.customerService.update(id, req.user.tenantId, updateCustomerDto);
  }
