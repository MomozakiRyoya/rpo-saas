...
export class JobController {
  ...
  async create(@Body() createJobDto: CreateJobDto, @Request() req) {
    return this.jobService.create(req.user.tenantId, req.user.userId, createJobDto);
  }
  ...
  async update(
    ...
    return this.jobService.update(id, req.user.tenantId, req.user.userId, updateJobDto);
  }
  ...
  async submitForApproval(@Param('id') id: string, @Request() req) {
    return this.jobService.submitForApproval(id, req.user.tenantId, req.user.userId);
  }
  ...
  async getDiff(
    ...
    return this.jobService.getDiff(id, req.user.tenantId, Number(v1), Number(v2));
  }
}
