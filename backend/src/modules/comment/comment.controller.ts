...
export class CommentController {
  ...
  async deleteComment(
    ...
    await this.commentService.deleteComment(id, req.user.tenantId, req.user.userId);
  }
  ...
  async addAssignment(
    ...
    return this.commentService.addAssignment(jobId, req.user.tenantId, body.userId);
  }
  ...
  async removeAssignment(
    ...
    await this.commentService.removeAssignment(jobId, req.user.tenantId, userId);
  }
}
